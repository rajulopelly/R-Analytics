# Data Exploration
library(readr)
outbreak <- read_csv("C:/Users/Unitech4/Downloads/outbreak.csv")
View(outbreak)
str(outbreak)
names(outbreak)
nrow(outbreak)
...
# Data Visualization
plot(time_data$age)
barplot(time_data$age)
boxplot(time_data$age)
hist(time_data$age, xlab = "Age in Years", main = "Distribution of Ages")
subset(time_data, age > 100)
time_data$age[28] <- 62
plot(time_data$age)
barplot(time_data$age)
boxplot(time_data$age)
hist(time_data$age, main = "Distribution of Ages", xlab = "Age in Years")
